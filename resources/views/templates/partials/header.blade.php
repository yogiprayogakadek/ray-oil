<div class="app-header header sticky" style="margin-bottom: -74px;">
    <div class="container-fluid main-container">
        <div class="d-flex"> <a aria-label="Hide Sidebar" class="app-sidebar__toggle"
                ...
                class="logo-horizontal " href="index.html"> <img src="{{asset('assets/images/logo/rays_bali.png')}}"
                    class="header-brand-img desktop-logo" alt="logo"> <img
                    src="{{asset('assets/images/logo/rays_bali.png')}}" height="50px" class="header-brand-img light-logo1"
                    alt="logo"> </a> <!-- LOGO -->
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    <div class="drop-heading">
                                        <div class="text-center">
                                            <h5 class="text-dark mb-0 fs-14 fw-semibold">{{nama()}}
                                            </h5> <small class="text-muted">{{jabatan()}}</small>
                                        </div>
                                    </div>
                                    <div class="dropdown-divider m-0"></div> 
                                    <a class="dropdown-item"
                                        href="{{route('profil.index')}}"> <i class="dropdown-icon fe fe-user"></i>
                                        Profile </a> 
